...
gulp.task('serve', function(){
	...
	gulp.watch([paths.assets + '/pages/*'], function(cb) {
		cb();
	});
...
gulp.task('documents', function(){
	return gulp.src(paths.assets + '/documents/*').pipe(gulp.dest('./public/assets'));
})


gulp.task('data', function(){
	return gulp.src(paths.assets + '/data/*').pipe(gulp.dest('./public/data'));
})

gulp.task('scripts', function(){

	// index page
	gulp.src(paths.assets + '/scripts/index.js').pipe(gulp.dest('./public/js'));

	// artwork page
	return gulp.src(paths.assets + '/scripts/artApp.js').pipe(gulp.dest('./public/js'));
